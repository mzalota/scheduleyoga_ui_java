...
<title>ScheduleYoga.com Privacy Policy</title>
<meta name="description" content="ScheduleYoga.com Privacy Policy" />
...
<body>
	<div class="wrapper">
		...
		<h1>ScheudleYoga.com Privacy Policy</h1>
		...
		<div class="mainPanel">
			...
			<div style="font-family: arial">
				...
				may be asked to enter your: name or e-mail address. You may,
				however, visit our site anonymously.<br />
				<br />Google, as a third party vendor, uses cookies to serve ads on
				your site. Google's use of the DART cookie enables it to serve ads
				to your users based on their visit to your sites and other sites on
				...
				<br />Any of the information we collect from you may be used in one
				of the following ways: <br />
				<br />; To personalize your experience<br />(your information
				helps us to better respond to your individual needs)<br />
				<br />; To improve our website<br />(we continually strive to
				improve our website offerings based on the information and feedback
				we receive from you)<br />
				<br />; To improve customer service<br />(your information helps
				...
				access your personal information. <br /> <br />We offer the use of
				a secure server. All supplied sensitive/credit information is
				transmitted via Secure Socket Layer (SSL) technology and then
				encrypted into our Database to be only accessed by those authorized
				with special access rights to our systems, and are required to?keep
				the information confidential. <br />
				<br />After a transaction, your private information (credit cards,
				social security numbers, financials, etc.) will not be stored on our
				servers.<br />
				<br />
				<strong>Do we use cookies?</strong> <br />
				<br />Yes - Cookies are small files that a site or its service
				...
				information<br />
				<br /> We use cookies to keep track of advertisements and compile
				...
				help us conduct and improve our business.<br />
				<br />
				<strong>Do we disclose any information to outside parties?</strong>
				<br />
				<br />We do not sell, trade, or otherwise transfer to outside
				...
				<br /> Occasionally, at our discretion, we may include or offer
				...
				<br />By using our site, you consent to our online privacy policy.<br />
				<br />
				<strong>Changes to our Privacy Policy</strong> <br />
				<br />If we decide to change our privacy policy, we will post those
				changes on this page, send an email notifying you of any changes,
				and/or update the Privacy Policy modification date below. <br />
				<br />This policy was last modified on October 14, 2011<br />
				<br />
				<strong>Contacting Us</strong> <br />
				<br />If there are any questions regarding this privacy policy you
				may contact us using the information below. <br />
				<br />www.scheduleyoga.com
				<br />17 Post ave
				<br />Westbrook, 
				<br />Connecticut 06498
				<br />USA
				<br />
				<br />
				...
				This policy is powered by Free Privacy Policy and Rhino Support <a
					style='color: #000; text-decoration: none;'
					href='http://www.rhinosupport.com/service-desk-software.htm'
					target='_blank' href="nofollow">service desk software</a>. 
				<span></span>
				<span></span>
				<span></span>
